// render-ui.js
// Renderizado del panel lateral (UI de PONs, nodos y puertos).
// Se conecta con state.js para mutaciones y con main.js vía callbacks.
...
/** Vincula eventos globales de UI */
...
/** Cambia pestaña activa en la UI */
...
/** Renderiza un nodo y sus hijos en árbol */
function renderNodeTree(ponIndex, node, container, depth) {
  ...
  if (node.type === 'splitter') {
    ...
    nodeDiv.querySelector('.connect-split').onclick = () => {
      ...
      if (!port) return console.warn('Debes seleccionar un puerto disponible');
...
/** Actualiza la grilla de puertos de un splitter */
